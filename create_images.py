...
draw2.text((100, 100), 'Savia Dental', fill='#ffffff', font=font)
...
draw2_png.text((100, 100), 'Savia Dental', fill='#ffffff', font=font)
...
draw3.text((100, 100), 'Savia Dental', fill='#0ca9a9', font=font)
...
draw3_png.text((100, 100), 'Savia Dental', fill='#0ca9a9', font=font)
